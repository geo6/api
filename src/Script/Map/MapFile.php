...
class MapFile
{
    ...
    public function addLayerZone(
        ...
        $layer->data = 'the_geom from (SELECT nis5, the_geog::geometry AS the_geom FROM municipality JOIN municipality_geometry USING(nis5) WHERE nis5 IN('.implode(',', $municipalities).')) as subquery using unique nis5 using srid=4326';
