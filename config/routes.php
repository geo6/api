...
return function (Application $app, MiddlewareFactory $factory, ContainerInterface $container) : void {
    ...
    $app->get('/geocode/getStreetList/{source:urbis|crab|picc}/{nis5:[0-9]{5}}/{postalcode:[0-9]{4}}/{street}', [DbAdapterMiddleware::class, TokenMiddleware::class, StreetHandler::class], 'api.geocode.street.source.3.nis5');
    $app->get('/geocode/getStreetList/{source:urbis|crab|picc}/{locality}/{postalcode:[0-9]{4}}/{street}', [DbAdapterMiddleware::class, TokenMiddleware::class, StreetHandler::class], 'api.geocode.street.source.3');
    $app->get('/geocode/getStreetList/{source:urbis|crab|picc}/{nis5:[0-9]{5}}/{street}', [DbAdapterMiddleware::class, TokenMiddleware::class, StreetHandler::class], 'api.geocode.street.source.2.nis5');
    $app->get('/geocode/getStreetList/{source:urbis|crab|picc}/{postalcode:[0-9]{4}}/{street}', [DbAdapterMiddleware::class, TokenMiddleware::class, StreetHandler::class], 'api.geocode.street.source.2.postalcode');
    $app->get('/geocode/getStreetList/{source:urbis|crab|picc}/{locality}/{street}', [DbAdapterMiddleware::class, TokenMiddleware::class, StreetHandler::class], 'api.geocode.street.source.2');
    $app->get('/geocode/getStreetList/{source:urbis|crab|picc}/{nis5:[0-9]{5}}', [DbAdapterMiddleware::class, TokenMiddleware::class, StreetHandler::class], 'api.geocode.street.source.nis5');
    $app->get('/geocode/getStreetList/{source:urbis|crab|picc}/{postalcode:[0-9]{4}}', [DbAdapterMiddleware::class, TokenMiddleware::class, StreetHandler::class], 'api.geocode.street.source.postalcode');
    $app->get('/geocode/getStreetList/{source:urbis|crab|picc}/{street}', [DbAdapterMiddleware::class, TokenMiddleware::class, StreetHandler::class], 'api.geocode.street.source');
    ...
    $app->get('/geocode/getAddressList/{locality}/{postalcode}/{street}/[{number}]', [DbAdapterMiddleware::class, TokenMiddleware::class, AddressHandler::class], 'api.geocode.address.4');
